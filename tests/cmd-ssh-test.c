...
START_TEST(test_do_con_trol_120)
{
    ...
    do_con_write(vc, buf0, sizeof(buf0) - 1);
    compare_sshbuf(2, vce, "-bash: 01234567890123456789012345678901234567890123456789012345678901234567890123456789012345678901234567890123456789012");
    compare_sshbuf(3, vce, "34567890123456789: command not found");
